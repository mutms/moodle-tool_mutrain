...
// along with this page.  If not, see <https://www.gnu.org/licenses/>.
 ...
 */
final class framework_contextid extends \tool_mulib\external\form_autocomplete\categorycontext {
    /**
     * Returns required capability.
     * @return string
     */
    public static function get_required_capability(): string {
        return 'tool/mutrain:manageframeworks';
    }
}
