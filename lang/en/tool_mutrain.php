...
$string['extra_menu_management_framework'] = 'Framework actions';
...
$string['privacy:metadata'] = 'Training plugin does not store any personal data except completion caches.';
