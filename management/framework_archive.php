...
$pageurl = new moodle_url('/admin/tool/mutrain/management/framework_archive.php', ['id' => $framework->id]);
...
echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('framework_archive', 'tool_mutrain'));
echo $form->render();
echo $OUTPUT->footer();
